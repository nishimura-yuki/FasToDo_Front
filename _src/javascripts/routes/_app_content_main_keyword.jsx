...
module.exports = React.createClass({
    ...
    getTaskList:function( keyword ){
        var resList = [];
        var tasks = this.props.tasks;
        Object.keys(tasks).forEach(function(key) {
            var task = this[key];
            if( task.title.indexOf( keyword ) >= 0 ){
                resList.push( task );
            }
        }, tasks);
        return resList; 
    ...
    render: function(){
        ...
        var k = query.k ? query.k : "";

        return (
            <div>
                <div className="menu-title" >
                    <p>{Messages.get("app").keyword}</p>
                    {'" '+k+' "'}
                </div> 
                <TaskList 
                    tasks={ this.getTaskList( k ) }
...
var TaskList = React.createClass({
    ...
    createActiveTaskList: function( tasks, date, dragid){
        ...
        return (
            <div className="task-list-active_date" key={"tasklistforkeyword-active-"+date} >
    ...
    createDoneTaskList: function( tasks, date, single){
        ...
        return (
            <div className="task-list-active_date" key={"tasklistforkeyword-done-"+date} >
